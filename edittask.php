...
?>
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($title != "" && $description != "") {
            $edit_query = "UPDATE tasks SET title='$title', description='$description' WHERE id=$id";
                ...
                <form action="#" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="" class="form-control" placeholder=""
                            value="<?php echo $select_title?>" aria-describedby="helpId">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id=""
                                rows="3"><?php echo $select_description?></textarea>
                        </div>
